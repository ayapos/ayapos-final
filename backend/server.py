...
# Import routes
from routes import contacts, callbacks, auth, content, upload, pricing, company, testimonials, portfolio, services, faq, settings, leads, products, blog, hero, team, navigation, ai_assistant, media, pos_packages, popup
