...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Solutions Overview Section - Like Menulux */}
          ...
          <div className="grid lg:grid-cols-3 gap-12 items-center">
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <Link to="/pos" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Store className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Système POS Restaurant</span>
                    </Link>
                    <Link to="/digital" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Smartphone className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Self-Order Kiosk</span>
                    </Link>
                    <Link to="/digital" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Package className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Système Commande</span>
                    </Link>
                    <Link to="/digital" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Tablet className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Terminal Serveur</span>
                    </Link>
                    <Link to="/digital" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.ShoppingBag className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">App Mobile Commande</span>
                    </Link>
                    <Link to="/digital" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Bot className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Serveur Robot</span>
                    </Link>
                    <Link to="/digital" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Truck className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Gestion Livraison</span>
                    </Link>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <Link to="/pos" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      ...
                      <span className="group-hover:translate-x-1 transition-transform">Portail Web</span>
                    </Link>
                    <Link to="/pos" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.BarChart3 className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Rapport Mobile</span>
                    </Link>
                    <Link to="/pos" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Package className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Gestion Stock</span>
                    </Link>
                    <Link to="/pos" className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors group">
                      <LucideIcons.Building2 className="h-5 w-5" />
                      <span className="group-hover:translate-x-1 transition-transform">Gestion Centralisée</span>
                    </Link>
                  </div>
                </div>

                <div className="pt-4">
                  <p className="text-gray-600 text-sm">Équipement</p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center lg:text-left space-y-6">
              <h2 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                Restaurant, Café et Chaînes d'entreprises
              </h2>
              <h3 className="text-4xl lg:text-5xl font-bold text-gray-900">
                Systèmes POS Nouvelle Génération
              </h3>
              <p className="text-lg text-gray-600">
                Restaurant, café, hôtel, marché et chaînes d'entreprises - Nouveaux systèmes POS de nouvelle génération
              </p>
              <Link to="/pos">
                <Button 
                  size="lg" 
