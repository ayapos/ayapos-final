              ...
              <div className="relative z-10">
                ...
                <div className="relative">
                  ...
                  <img
                    ...
                    alt="POS Restaurant"
                    className="relative rounded-2xl shadow-2xl border-4 border-white/20 backdrop-blur transform scale-150 hover:scale-[1.6] transition-transform duration-500 object-cover"
                  />
                </div>
