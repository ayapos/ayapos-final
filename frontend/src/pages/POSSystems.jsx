        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            {displayPackages.map((pkg, index) => {
              ...
              const imageUrl = pkg.image || posImages[pkg.id] || 'https://images.unsplash.com/photo-1718279602896-6df6c34f61e5-10a1a75cff83?w=800';
              ...
              <Card key={pkg.id} className={`relative overflow-hidden ${
                ...
                <div className="relative h-48 w-full overflow-hidden bg-gray-100">
                  <img 
                    ...
                    onError={(e) => {
                      e.target.src = 'https://images.unsplash.com/photo-1718279602896-6df6c34f61e5-10a1a75cff83?w=800';
                    }}
                  />
