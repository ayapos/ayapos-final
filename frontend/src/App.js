...
import AyaPay from './pages/AyaPayDynamic';
...
import WaiterTerminal from './pages/WaiterTerminalDynamic';
...
import KioskPricing from './pages/KioskPricingDynamic';
import OrderSystemPricing from './pages/OrderSystemPricingDynamic';
import DeliveryServicePricing from './pages/DeliveryServicePricingDynamic';
import WaiterTerminalPricing from './pages/WaiterTerminalPricingDynamic';
import HardwareDevices from './pages/HardwareDevicesDynamic';
import About from './pages/AboutDynamic';
...
import TermsConditions from './pages/TermsConditionsDynamic';
import PrivacyPolicy from './pages/PrivacyPolicyDynamic';
import ITServices from './pages/ITServicesDynamic';
