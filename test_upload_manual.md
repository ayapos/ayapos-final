...
```
1. Allez sur: https://media-manager-cms.preview.emergentagent.com/admin/login
...
2. Ou allez sur: https://media-manager-cms.preview.emergentagent.com/waiter-terminal
